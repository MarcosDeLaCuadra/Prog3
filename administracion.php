           ...
           for ($i=0; $i <count($array_nombre) ; $i++)
            ...
            else
            {
              ...
              $conexion =mysqli_connect("localhost","root","", "empleado");   
               $consulta=mysqli_query($conexion, "INSERT INTO empleado ( `nombre`, `apellido`, `dni`, `sexo`, `sueldo`, `legajo`, `foto`) VALUES ('".$nombre."' , '".$apellido ."' , ".$dni ."  , '". $sexo."'  ,".$sueldo ."  ,".$legajo ."  , '". $foto."'  ) " );
         
            
                $empleado = new Empleado($nombre, $apellido, $dni ,$sexo , $sueldo, $legajo, $foto);
